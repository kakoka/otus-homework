...
И уже на них создал том и примонтирован в каталог /var.

Так же была создана группа томов и был примонтирован в каталог /opt. На этом томе файловая система btrfs.
